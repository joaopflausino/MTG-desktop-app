...
public class RegisterForm extends javax.swing.JFrame {
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        if(jTextField2.getText().equals(jTextField3.getText())){
            try {
                SL.registerUser(jTextField1.getText(), jTextField2.getText());
            ...
            JOptionPane.showMessageDialog(null, "O Campo de confirmação de senha precisa ser igual ao da senha ");
        }
